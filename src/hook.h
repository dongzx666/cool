#ifndef __COOL_HOOK_H
#define __COOL_HOOK_H
...
typedef int (*bind_fun)(int sockfd, const struct sockaddr *addr,
                        socklen_t addrlen);
...
// typedef int (*connect_with_timeout_fun) (int sockfd, const struct sockaddr *addr, socklen_t addrlen, uint64_t timeout_ms);
